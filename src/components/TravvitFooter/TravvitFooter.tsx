      ...
      <div id="footer-wrapper" className="pt-32 pl-8 pr-8 pb-2 max-w-full">
        <section id="branding-menu" className="flex flex-col basis-1/2">
          <section id="branding">
            ...
            <p className="text-sm mt-8">Explore Together!</p>
            <div id="social-links" className="flex mt-8">
              <a
                href="#"
                className="opacity-40 hover:opacity-60 ml-6 first:ml-0"
              >
                <svg
                  fill="currentColor"
                  viewBox="0 0 24 24"
        ...
        <section id="copyright" className="flex flex-col basis-1/2">
          <p className="text-sm">
            <a
              href="#"
