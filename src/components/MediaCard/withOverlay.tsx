...
const DEFAULT_OVERLAY_CLASSES = `action-overlay absolute top-0 left-0 w-auto h-full bg-black-500 flex flex-col justify-center items-center p-4 text-white`;
